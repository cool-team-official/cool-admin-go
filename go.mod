...
require (
	...
	github.com/cool-team-official/cool-admin-go/contrib/drivers/pgsql v1.5.5
	github.com/cool-team-official/cool-admin-go/contrib/files/local v1.5.5
	github.com/cool-team-official/cool-admin-go/cool v1.5.5
	github.com/cool-team-official/cool-admin-go/modules/base v1.5.5
	github.com/cool-team-official/cool-admin-go/modules/demo v1.5.5

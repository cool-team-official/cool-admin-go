...
require (
	github.com/cool-team-official/cool-admin-go/contrib/drivers/mysql v0.0.23
	github.com/cool-team-official/cool-admin-go/contrib/drivers/sqlite v0.0.23
	github.com/cool-team-official/cool-admin-go/contrib/files/local v0.0.23
	github.com/cool-team-official/cool-admin-go/modules/base v0.0.23
	github.com/cool-team-official/cool-admin-go/modules/demo v0.0.23
	github.com/cool-team-official/cool-admin-go/modules/dict v0.0.23
